...
void calcGrades(std::vector<CollegePerson*>& records) {
    for (auto* person : records) {
        ...
        if (grade > 94) { person->setGpa(4.5); person->setLetterGrade("A+"); }
        else if (grade > 89) { person->setGpa(4.0); person->setLetterGrade("A"); }
        else if (grade > 84) { person->setGpa(3.5); person->setLetterGrade("B+"); }
        else if (grade > 79) { person->setGpa(3.0); person->setLetterGrade("B"); }
        else if (grade > 74) { person->setGpa(2.5); person->setLetterGrade("C+"); }
        else if (grade > 69) { person->setGpa(2.0); person->setLetterGrade("C"); }
        else if (grade > 64) { person->setGpa(1.5); person->setLetterGrade("D+"); }
